...
if __name__ == "__main__":
    ...
    # TODO: should logger be initialized already here?
        ...
        parser = argparse.ArgumentParser(description="Run ALFOSC imaging reduction pipeline")
        parser.add_argument("raw_data_path", type=Path, help="Path to raw data")
        parser.add_argument("-out", "--output-dir", type=Path,
        ...
        parser.add_argument("instrument", type=str, help="Instrument to use. Options: ALFOSC")
        ...
        output_dir = args.output_dir or (raw_data_path / "reduced")
        ...
        # Pass instrument and output_dir to the pipeline (ReductionPipeline expected to accept them)
