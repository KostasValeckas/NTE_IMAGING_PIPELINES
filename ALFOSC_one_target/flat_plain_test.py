...
hdu_bias.header['COMMENT'] = "Master bias (median of bias frames), written by flat_plain_test.py"
...
master_flat_safe = np.where(np.isfinite(master_flat) & (master_flat != 0), master_flat, 1.0)
